        ...
        <div className="min-h-screen w-full flex bg-default">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-card flex-col justify-between p-12 border-r border-default">
                ...
                <div>
                    <h1 className="text-4xl font-bold text-default mb-4">
                        {t.loginTitle}<br />
                        <span className="text-purple-500">{t.loginTitleHighlight}</span>
                    </h1>
                ...
                <div className="flex items-center gap-8">
                    <div>
                        <p className="text-3xl font-bold text-default">1000+</p>
                        <p className="text-muted text-sm">{t.statsUsers}</p>
                    </div>
                    <div className="w-px h-12 bg-default"></div>
                    <div>
                        <p className="text-3xl font-bold text-default">₺50K+</p>
                        <p className="text-muted text-sm">{t.statsPayments}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-default">
                <div className="w-full max-w-md">
                    ...
                    {needsVerification && (
                        <div className="bg-amber-500/10 border border-amber-500/20 text-amber-400 px-4 py-4 rounded-lg mb-6">
                            <div className="flex items-center gap-2 mb-2">
                                <Mail size={18} />
                                <span className="font-medium">{t.checkEmail}</span>
                            </div>
                            <p className="text-sm text-muted mb-3">
                                {t.checkEmailDesc}
                            </p>
                            {resendSuccess ? (
                                <p className="text-sm text-green-400">✓ {t.processing}</p>
                            ) : (
                                <button
                                ...
                                >
                                    {resendLoading ? t.processing : 'Tekrar gönder'}
                                </button>
                            )}
                        </div>
                    )}
